...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="container container-corpo">
	      	<div class="jumbotron">
	        	<h1>Não foi possível localizar o evento :(</h1>
                <br>
	        	<p class="sucesso">
                    <a href="buscar-evento.php">Clique aqui</a> para voltar para a página de busca de eventos, ou <a href="index.php">aqui</a> para ir para a página inicial do Fest.On
                </p>
	      	</div>
